...
export const INITIAL_MESSAGE: string = `🥑 Hey, I’m ${AI_NAME}, ${OWNER_NAME}'s AI kitchen recipe developer! Got a fridge full of ‘nothing to eat’? Challenge accepted. Toss me some ingredients, and I’ll turn them into magic. Let’s get cooking! 👨‍🍳✨`;
