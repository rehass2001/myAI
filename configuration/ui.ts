...
export const CHAT_HEADER: string = `ChefMate`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI By Raheq Hassan`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat for New Recipes`;
